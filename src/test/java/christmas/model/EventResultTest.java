...
public class EventResultTest {
    ...
    void of_EqualResult_Success() {
        //given
        EventResult eventResult = EventResult.of(new Reservation("티본스테이크-1,바비큐립-1,초코케이크-2,제로콜라-1", new ChristmasCalendar(5)));
        //when
    ...
    void calculateExpectedPaymentAmount_EqualResult_Success() {
        //given
        Reservation reservation = new Reservation("티본스테이크-1,바비큐립-1,초코케이크-2,제로콜라-1", new ChristmasCalendar(5));
